...
public class CommonInit
{
    ...
    public void addRecipes()
    {
        ...
        {
            GameRegistry.addRecipe(new ItemStack(Slopes.BlockKaevSandstoneSlopes, 3, 4), new Object[] {"#  ", " # ", "###", '#', Block.sandStone});
            GameRegistry.addRecipe(new ItemStack(Slopes.BlockKaevSandstoneSlopes, 3, 12), new Object[] {" # ", " ##", " # ", '#', Block.sandStone});

            if (Slopes.props.getBoolean("BlockInversion"))
            {
                GameRegistry.addRecipe(new ItemStack(Slopes.BlockKaevSandstoneSlopes, 3, 8), new Object[] {"###", " # ", "#  ", '#', Block.sandStone});
            }
        }
