...
public class CommonInit
{
    ...
    public void addRecipes()
    {
        ...
        {
            GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevSandstoneCorners, 3, 0), new Object[] {" # ", "###", '#', Block.sandStone});
            GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevSandstoneCorners, 3, 8), new Object[] {" # ", " # ", "###", '#', Block.sandStone});

            if (Corners.props.getBoolean("BlockInversion"))
            {
                GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevSandstoneCorners, 3, 4), new Object[] {"###", " # ", '#', Block.sandStone});
                GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevSandstoneCorners, 3, 12), new Object[] {"###", " # ", " # ", '#', Block.sandStone});
            }
        }
        ...
        {
            GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevWhiteWoolCorners, 3, 0), new Object[] {" # ", "###", '#', Block.cloth});
            GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevWhiteWoolCorners, 3, 8), new Object[] {" # ", " # ", "###", '#', Block.cloth});

            if (Corners.props.getBoolean("BlockInversion"))
            {
                GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevWhiteWoolCorners, 3, 4), new Object[] {"###", " # ", '#', Block.cloth});
                GameRegistry.addRecipe(new ItemStack(Corners.BlockKaevWhiteWoolCorners, 3, 12), new Object[] {"###", " # ", " # ", '#', Block.cloth});
            }
        }
    }
    ...
    public void loadConfig()
    {
        ...
        if (Corners.props.getInt("CobblestoneCorners") != 0)
        {
            Corners.BlockKaevCobblestoneCorners = (new BlockCorners(Corners.props.getInt("CobblestoneCorners"), 16, Material.rock)).setHardness(2.0F).setStepSound(Block.soundStoneFootstep).setResistance(10.0F).setBlockName("CobblestoneCorners");
        ...
        if (Corners.props.getInt("GlassCorners") != 0)
        {
            Corners.BlockKaevGlassCorners = (new BlockCorners(Corners.props.getInt("GlassCorners"), 49, Material.glass)).setHardness(0.3F).setStepSound(Block.soundGlassFootstep).setBlockName("GlassCorners");
        ...
        if (Corners.props.getInt("DirtCorners") != 0)
        {
            Corners.BlockKaevDirtCorners = (new BlockCorners(Corners.props.getInt("DirtCorners"), 2, Material.ground)).setHardness(0.5F).setStepSound(Block.soundGravelFootstep).setBlockName("DirtCorners");
        ...
        if (Corners.props.getInt("StoneCorners") != 0)
        {
            Corners.BlockKaevStoneCorners = (new BlockCorners(Corners.props.getInt("StoneCorners"), 1, Material.rock)).setHardness(1.5F).setStepSound(Block.soundStoneFootstep).setResistance(10.0F).setBlockName("StoneCorners");
        ...
        if (Corners.props.getInt("SandCorners") != 0)
        {
            Corners.BlockKaevSandCorners = (new BlockCorners(Corners.props.getInt("SandCorners"), 18, Material.sand)).setHardness(0.5F).setStepSound(Block.soundSandFootstep).setBlockName("SandCorners");
        ...
        if (Corners.props.getInt("SnowCorners") != 0)
        {
            Corners.BlockKaevSnowCorners = (new BlockCorners(Corners.props.getInt("SnowCorners"), 66, Material.snow)).setHardness(0.1F).setStepSound(Block.soundClothFootstep).setBlockName("SnowCorners");
        ...
        if (Corners.props.getInt("GrassCorners") != 0)
        {
            Corners.BlockKaevGrassCorners = (new BlockCorners(Corners.props.getInt("GrassCorners"), 3, Material.ground)).setHardness(0.6F).setStepSound(Block.soundGrassFootstep).setBlockName("GrassCorners");
        ...
        if (Corners.props.getInt("BricksCorners") != 0)
        {
            Corners.BlockKaevBricksCorners = (new BlockCorners(Corners.props.getInt("BricksCorners"), 7, Material.rock)).setHardness(2.0F).setStepSound(Block.soundStoneFootstep).setResistance(10.0F).setBlockName("BricksCorners");
        ...
        if (Corners.props.getInt("GravelCorners") != 0)
        {
            Corners.BlockKaevGravelCorners = (new BlockCorners(Corners.props.getInt("GravelCorners"), 19, Material.sand)).setHardness(0.6F).setStepSound(Block.soundGravelFootstep).setBlockName("GravelCorners");
        ...
        if (Corners.props.getInt("GoldCorners") != 0)
        {
            Corners.BlockKaevGoldCorners = (new BlockCorners(Corners.props.getInt("GoldCorners"), 23, Material.iron)).setHardness(3.0F).setStepSound(Block.soundMetalFootstep).setResistance(10.0F).setBlockName("GoldCorners");
        ...
        if (Corners.props.getInt("IronCorners") != 0)
        {
            Corners.BlockKaevSteelCorners = (new BlockCorners(Corners.props.getInt("IronCorners"), 22, Material.iron)).setHardness(5.0F).setStepSound(Block.soundMetalFootstep).setResistance(10.0F).setBlockName("SteelCorners");
        ...
        if (Corners.props.getInt("ObsidianCorners") != 0)
        {
            Corners.BlockKaevObsidianCorners = (new BlockCorners(Corners.props.getInt("ObsidianCorners"), 37, Material.rock)).setHardness(10.0F).setStepSound(Block.soundStoneFootstep).setResistance(2000.0F).setBlockName("ObsidianCorners");
        ...
        if (Corners.props.getInt("DiamondCorners") != 0)
        {
            Corners.BlockKaevDiamondCorners = (new BlockCorners(Corners.props.getInt("DiamondCorners"), 24, Material.iron)).setHardness(5.0F).setStepSound(Block.soundMetalFootstep).setResistance(10.0F).setBlockName("DiamondCorners");
        ...
        {
            Corners.BlockKaevSilverWoolCorners = (new BlockCorners(Corners.props.getInt("LightGrayWoolCorners"), 225, Material.cloth)).setHardness(1.0F).setStepSound(Block.soundClothFootstep).setBlockName("SilverWoolCorners");
            Corners.ItemKaevSilverWoolCorners = (new ItemCorners(Corners.BlockKaevSilverWoolCorners.blockID - 256, "SilverWool")).setItemName("SilverWoolCorners");
        }
        else
        {
            Corners.BlockKaevSilverWoolCorners = Block.stone;
        }
