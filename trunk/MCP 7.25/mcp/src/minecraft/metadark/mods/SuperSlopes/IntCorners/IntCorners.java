...
public class IntCorners {
    ...
    public static Block BlockKaevSmoothSandstoneIntCorners;
    public static Block BlockKaevChiseledSandstoneIntCorners;
    ...
    public static Block BlockKaevLightGrayWoolIntCorners;
    ...
    public static Item ItemKaevSmoothSandstoneIntCorners;
    public static Item ItemKaevChiseledSandstoneIntCorners;
    ...
    public static void prepareProps() {
        ...
        props.getInt("SmoothSandstoneIntCorners", 0);
        props.getInt("ChiseledSandstoneIntCorners", 0);
