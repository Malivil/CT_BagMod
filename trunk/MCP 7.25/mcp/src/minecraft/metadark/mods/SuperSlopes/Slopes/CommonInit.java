...
public class CommonInit {
    ...
    public void addRecipes() {
        ...
        final Block[] blocks = {Slopes.BlockKaevWhiteWoolSlopes, Slopes.BlockKaevOrangeWoolSlopes, Slopes.BlockKaevMagentaWoolSlopes, Slopes.BlockKaevLightBlueWoolSlopes,
        						Slopes.BlockKaevYellowWoolSlopes, Slopes.BlockKaevLimeWoolSlopes, Slopes.BlockKaevPinkWoolSlopes, Slopes.BlockKaevGrayWoolSlopes,
        						Slopes.BlockKaevLightGrayWoolSlopes, Slopes.BlockKaevCyanWoolSlopes, Slopes.BlockKaevPurpleWoolSlopes, Slopes.BlockKaevBlueWoolSlopes,
        						Slopes.BlockKaevBrownWoolSlopes, Slopes.BlockKaevGreenWoolSlopes, Slopes.BlockKaevRedWoolSlopes, Slopes.BlockKaevBlackWoolSlopes};
    ...
    public void loadConfig() {
        ...
        if (Slopes.props.getInt("CobblestoneSlopes") != 0) {
            Slopes.BlockKaevCobblestoneSlopes = (new BlockSlopes(Slopes.props.getInt("CobblestoneSlopes"), Block.cobblestone.blockIndexInTexture, Material.rock)).setHardness(2.0F).setStepSound(Block.soundStoneFootstep).setResistance(10.0F).setBlockName("CobblestoneSlopes");
        ...
        if (Slopes.props.getInt("GlassSlopes") != 0) {
            Slopes.BlockKaevGlassSlopes = (new BlockSlopes(Slopes.props.getInt("GlassSlopes"), Block.glass.blockIndexInTexture, Material.glass)).setHardness(0.3F).setStepSound(Block.soundGlassFootstep).setBlockName("GlassSlopes");
        ...
        if (Slopes.props.getInt("DirtSlopes") != 0) {
            Slopes.BlockKaevDirtSlopes = (new BlockSlopes(Slopes.props.getInt("DirtSlopes"), Block.dirt.blockIndexInTexture, Material.ground)).setHardness(0.5F).setStepSound(Block.soundGravelFootstep).setBlockName("DirtSlopes");
        ...
        if (Slopes.props.getInt("StoneSlopes") != 0) {
            Slopes.BlockKaevStoneSlopes = (new BlockSlopes(Slopes.props.getInt("StoneSlopes"), Block.stone.blockIndexInTexture, Material.rock)).setHardness(1.5F).setStepSound(Block.soundStoneFootstep).setResistance(10.0F).setBlockName("StoneSlopes");
        ...
        if (Slopes.props.getInt("SandSlopes") != 0) {
            Slopes.BlockKaevSandSlopes = (new BlockSlopes(Slopes.props.getInt("SandSlopes"), Block.sand.blockIndexInTexture, Material.sand)).setHardness(0.5F).setStepSound(Block.soundSandFootstep).setBlockName("SandSlopes");
        ...
        if (Slopes.props.getInt("SnowSlopes") != 0) {
            Slopes.BlockKaevSnowSlopes = (new BlockSlopes(Slopes.props.getInt("SnowSlopes"), Block.snow.blockIndexInTexture, Material.snow)).setHardness(0.1F).setStepSound(Block.soundClothFootstep).setBlockName("SnowSlopes");
        ...
        if (Slopes.props.getInt("GrassSlopes") != 0) {
            Slopes.BlockKaevGrassSlopes = (new BlockSlopes(Slopes.props.getInt("GrassSlopes"), Block.grass.blockIndexInTexture, Material.ground)).setHardness(0.6F).setStepSound(Block.soundGrassFootstep).setBlockName("GrassSlopes");
        ...
        if (Slopes.props.getInt("BricksSlopes") != 0) {
            Slopes.BlockKaevBricksSlopes = (new BlockSlopes(Slopes.props.getInt("BricksSlopes"), Block.brick.blockIndexInTexture, Material.rock)).setHardness(2.0F).setStepSound(Block.soundStoneFootstep).setResistance(10.0F).setBlockName("BricksSlopes");
        ...
        if (Slopes.props.getInt("GravelSlopes") != 0) {
            Slopes.BlockKaevGravelSlopes = (new BlockSlopes(Slopes.props.getInt("GravelSlopes"), Block.gravel.blockIndexInTexture, Material.sand)).setHardness(0.6F).setStepSound(Block.soundGravelFootstep).setBlockName("GravelSlopes");
        ...
        if (Slopes.props.getInt("GoldSlopes") != 0) {
            Slopes.BlockKaevGoldSlopes = (new BlockSlopes(Slopes.props.getInt("GoldSlopes"), Block.blockGold.blockIndexInTexture, Material.iron)).setHardness(3.0F).setStepSound(Block.soundMetalFootstep).setResistance(10.0F).setBlockName("GoldSlopes");
        ...
        if (Slopes.props.getInt("IronSlopes") != 0) {
            Slopes.BlockKaevSteelSlopes = (new BlockSlopes(Slopes.props.getInt("IronSlopes"), Block.blockSteel.blockIndexInTexture, Material.iron)).setHardness(5.0F).setStepSound(Block.soundMetalFootstep).setResistance(10.0F).setBlockName("SteelSlopes");
        ...
        if (Slopes.props.getInt("ObsidianSlopes") != 0) {
            Slopes.BlockKaevObsidianSlopes = (new BlockSlopes(Slopes.props.getInt("ObsidianSlopes"), Block.obsidian.blockIndexInTexture, Material.rock)).setHardness(10.0F).setStepSound(Block.soundStoneFootstep).setResistance(2000.0F).setBlockName("ObsidianSlopes");
        ...
        if (Slopes.props.getInt("DiamondSlopes") != 0) {
            Slopes.BlockKaevDiamondSlopes = (new BlockSlopes(Slopes.props.getInt("DiamondSlopes"), Block.blockDiamond.blockIndexInTexture, Material.iron)).setHardness(5.0F).setStepSound(Block.soundMetalFootstep).setResistance(10.0F).setBlockName("DiamondSlopes");
        ...
        if (Slopes.props.getInt("LightGrayWoolSlopes") != 0) {
            Slopes.BlockKaevLightGrayWoolSlopes = (new BlockSlopes(Slopes.props.getInt("LightGrayWoolSlopes"), 225, Material.cloth)).setHardness(1.0F).setStepSound(Block.soundClothFootstep).setBlockName("SilverWoolSlopes");
            Slopes.ItemKaevSilverWoolSlopes = (new ItemSlopes(Slopes.BlockKaevLightGrayWoolSlopes.blockID - 256, "SilverWool")).setItemName("SilverWoolSlopes");
        }
        else
            Slopes.BlockKaevLightGrayWoolSlopes = Block.stone;
