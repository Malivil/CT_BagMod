...
public class BlockTriplePistonBase extends BlockPistonBase
{
    ...
    public BlockTriplePistonBase(int var1, int var2, boolean var3)
    {
    ...
    public int getBlockTextureFromSideAndMetadata(int var1, int var2)
    {
        ...
        return var3 > 5 ? this.blockIndexInTexture : (var1 == var3 ? (!isExtended(var2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? (!this.isSticky ? 1 : 0) : 20) : (var1 != Facing.faceToSide[var3] ? 21 : 19));
    }
    ...
    public void onBlockEventReceived(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        {
            int var8 = Monty_Util.extraDisp2 + 1;
            int var9 = var2;
            int var10 = var3;
            int var11 = var4;
            ...
            TileEntityMorePistons var25 = (TileEntityMorePistons)mod_MorePistons.getTileEntity(this.blockID, var7, var7, false, true);
    ...
    private boolean tryExtend(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        int var7 = Monty_Util.extraDisp2;
        int var8 = 1 + var7;
        int var9 = 0;
        int var10 = var2;
        int var11 = var3;
