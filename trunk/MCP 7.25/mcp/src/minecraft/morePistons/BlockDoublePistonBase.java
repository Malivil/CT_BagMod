...
public class BlockDoublePistonBase extends BlockPistonBase
{
    ...
    public BlockDoublePistonBase(int var1, int var2, boolean var3)
    {
    ...
    public int getBlockTextureFromSideAndMetadata(int var1, int var2)
    {
        ...
        return var3 > 5 ? 1 : (var1 == var3 ? (!isExtended(var2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? (!this.isSticky ? 1 : 0) : 17) : (var1 != Facing.faceToSide[var3] ? 18 : 16));
    }
    ...
    public void onBlockEventReceived(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        {
            int var8 = Monty_Util.extraDisp + 1;
            int var9 = var2;
            int var10 = var3;
            int var11 = var4;
            ...
            TileEntityMorePistons var27 = (TileEntityMorePistons)mod_MorePistons.getTileEntity(this.blockID, var7, var7, false, true);
            var1.setBlockTileEntity(var2, var3, var4, var27);
            int var14;
            int var15;
            int var16;
            int var28;
            ...
            if (this.isSticky)
            {
                ...
                {
                    var28 += Facing.offsetsXForSide[var7];
                    var14 += Facing.offsetsYForSide[var7];
                    var15 += Facing.offsetsZForSide[var7];
                }

                int var19 = var1.getBlockId(var28, var14, var15);
                int var20 = var1.getBlockMetadata(var28, var14, var15);
                boolean var21 = false;
                TileEntityMorePistons var23;

                if (var19 == Block.pistonMoving.blockID)
                {
                    TileEntity var22 = var1.getBlockTileEntity(var28, var14, var15);

                    if (var22 != null && var22 instanceof TileEntityMorePistons)
                    {
                        var23 = (TileEntityMorePistons)var22;
                ...
                for (var30 = 0; var30 < MorePistons.pistonList.length; ++var30)
                {
                    if (var19 == MorePistons.pistonList[var30])
                    {
                        var29 = true;
                        break;
                    }

                    if (var30 == MorePistons.pistonList.length - 1 && !var29)
                    {
                        var29 = false;
                    }
                }

                if (!var21 && var19 > 0 && canPushBlock(var19, var1, var28, var14, var15, false) && (Block.blocksList[var19].getMobilityFlag() == 0 || var29))
                {
                    ...
                    var23 = (TileEntityMorePistons)mod_MorePistons.getTileEntity(var19, var20, var7, false, false);
                    var1.setBlockTileEntity(var2, var3, var4, var23);
                    ignoreUpdates = false;
                    var1.setBlockWithNotify(var28, var14, var15, 0);
                    int var24 = var1.getBlockId(var28, var14, var15);
                    var28 = var2;
                    var14 = var3;
                    var15 = var4;
                    ...
                    for (int var25 = 0; var25 < var8 - 1; ++var25)
                    {
                        ...
                        var15 += Facing.offsetsZForSide[var7];
                        var1.setBlockWithNotify(var28, var14, var15, 0);
                        var1.getBlockId(var28, var14, var15);
                    }
                ...
                else if (!var21)
                {
                    ...
                    var30 = var1.getBlockId(var2, var3, var4);
                    ignoreUpdates = true;
                }
            }
            else
            {
                ...
                for (var16 = 0; var16 < var8; ++var16)
                {
                    ...
                    var14 += Facing.offsetsYForSide[var7];
                    var15 += Facing.offsetsZForSide[var7];
                    int var17 = var1.getBlockId(var28, var14, var15);
        ...
        while (true)
        {
            ...
            if (var16 < 13)
            {
                label102:
                {
                    ...
                    var17 = var1.getBlockId(var13, var24, var15);
                    int var18 = var1.getBlockMetadata(var13, var24, var15);
                    ...
                    if (var17 != 0)
                    {
                        ...
                        Monty_Util var28 = new Monty_Util(var13, var24, var15, var20, var21, var22);
                        var28.blockId2 = var17;
                        var28.metadata2 = var18;
                        var6.add(var28);
                    }
            ...
            {
                Monty_Util var25 = (Monty_Util)var6.get(var17);
                TileEntityMorePistons var26;

                if (var25.blockId2 == MorePistons.pistonRod.blockID)
                {
                    var19 = var5 | (this.isSticky ? 8 : 0);
                    var1.setBlockAndMetadata(var25.x2, var25.y2, var25.z2, Block.pistonMoving.blockID, var19);
                    var26 = (TileEntityMorePistons)mod_MorePistons.getTileEntity(MorePistons.pistonRod.blockID, var19, var5, true, false);
                    var1.setBlockTileEntity(var25.x2, var25.y2, var25.z2, var26);
                }
                else if (var25.blockId2 == MorePistons.pistonExtension.blockID)
                {
                    var19 = var5 | (this.isSticky ? 8 : 0);
                    var1.setBlockAndMetadata(var25.x2, var25.y2, var25.z2, Block.pistonMoving.blockID, var19);
                    var26 = (TileEntityMorePistons)mod_MorePistons.getTileEntity(MorePistons.pistonExtension.blockID, var19, var5, true, false);
                    var1.setBlockTileEntity(var25.x2, var25.y2, var25.z2, var26);
                }
                else
                {
                    var1.setBlockAndMetadata(var25.x2, var25.y2, var25.z2, Block.pistonMoving.blockID, var25.metadata2);
                    TileEntityMorePistons var27 = (TileEntityMorePistons)mod_MorePistons.getTileEntity(var25.blockId2, var25.metadata2, var5, true, false);
                    var1.setBlockTileEntity(var25.x2, var25.y2, var25.z2, var27);
                }
            }
