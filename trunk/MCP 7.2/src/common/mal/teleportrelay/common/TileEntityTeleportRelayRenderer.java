...
public class TileEntityTeleportRelayRenderer extends TileEntitySpecialRenderer {
	private ModelTeleportRelay aModel;

	public TileEntityTeleportRelayRenderer() {
		aModel = new ModelTeleportRelay();
	}

	public void renderAModelAt(TileEntityTeleportRelay tileentity, double d, double d1, double d2, float f) {
		GL11.glPushMatrix();
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) {
		this.renderAModelAt((TileEntityTeleportRelay)tileentity, d, d1, d2, f);
	}
}
