...
public class ClientInit extends CommonInit
{
    ...
    public void addLocalizations()
    {
        ...
        ModLoader.addLocalization("KaevSmoothSandstoneSlopesTruncCornerDown.name", "Smooth Sandstone Oblique Slope");
        ModLoader.addLocalization("KaevSmoothSandstoneSlopesTruncCornerUp.name", "Smooth Sandstone Oblique Slope Inv");
        ModLoader.addLocalization("KaevSmoothSandstoneSlopesInvCornerDown.name", "Smooth Sandstone Interior Corner");
        ModLoader.addLocalization("KaevSmoothSandstoneSlopesInvCornerUp.name", "Smooth Sandstone Interior Corner Inv");
        ModLoader.addLocalization("KaevChiseledSandstoneSlopesTruncCornerDown.name", "Chiseled Sandstone Oblique Slope");
        ModLoader.addLocalization("KaevChiseledSandstoneSlopesTruncCornerUp.name", "Chiseled Sandstone Oblique Slope Inv");
        ModLoader.addLocalization("KaevChiseledSandstoneSlopesInvCornerDown.name", "Chiseled Sandstone Interior Corner");
        ModLoader.addLocalization("KaevChiseledSandstoneSlopesInvCornerUp.name", "Chiseled Sandstone Interior Corner Inv");
