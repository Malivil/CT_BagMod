...
public class RenderIntCorners implements ISimpleBlockRenderingHandler
{
    ...
    public void renderInventoryBlock(Block var1, int var2, int var3, RenderBlocks var4)
    {
        ...
        if (var3 == this.getRenderId())
        {
            ...
            this.renderIntCornersBottomFace(var1, 0.0D, 0.0D, 0.0D, var1.getBlockTextureFromSideAndMetadata(0, var2), var2 + 1, var4, 240);
            var5.draw();
            var5.startDrawingQuads();
            var5.setNormal(0.0F, 1.0F, 0.0F);
            this.renderIntCornersTopFace(var1, 0.0D, 0.0D, 0.0D, var1.getBlockTextureFromSideAndMetadata(1, var2), var2 + 1, var4, 240);
            var5.draw();
            var5.startDrawingQuads();
            var5.setNormal(0.0F, 0.0F, -1.0F);
            this.renderIntCornersEastFace(var1, 0.0D, 0.0D, 0.0D, var1.getBlockTextureFromSideAndMetadata(2, var2), var2 + 1, var4, 240);
            var5.draw();
            var5.startDrawingQuads();
            var5.setNormal(0.0F, 0.0F, 1.0F);
            this.renderIntCornersWestFace(var1, 0.0D, 0.0D, 0.0D, var1.getBlockTextureFromSideAndMetadata(3, var2), var2 + 1, var4, 240);
            var5.draw();
            var5.startDrawingQuads();
            var5.setNormal(-1.0F, 0.0F, 0.0F);
            this.renderIntCornersNorthFace(var1, 0.0D, 0.0D, 0.0D, var1.getBlockTextureFromSideAndMetadata(4, var2), var2 + 1, var4, 240);
            var5.draw();
            var5.startDrawingQuads();
            var5.setNormal(1.0F, 0.0F, 0.0F);
            this.renderIntCornersSouthFace(var1, 0.0D, 0.0D, 0.0D, var1.getBlockTextureFromSideAndMetadata(5, var2), var2 + 1, var4, 240);
            var5.draw();
            GL11.glTranslatef(0.5F, 0.5F, 0.5F);
        }
    ...
    public boolean renderIntCornersBlockWithColorMultiplier(Block var1, int var2, int var3, int var4, float var5, float var6, float var7, int var8, RenderBlocks var9, IBlockAccess var10)
    {
        ...
        if (var9.renderAllFaces || var1.shouldSideBeRendered(var10, var2, var3 + 1, var4, 1) || var8 / 4 == 0 || var8 / 4 == 2)
        {
            ...
            if (var1.func_83010_y() != 1.0D && !var1.blockMaterial.isLiquid() || var8 / 4 == 0 || var8 / 4 == 2)
            {
                var30 = var29;
            }
    ...
    public void renderIntCornersBottomFace(Block var1, double var2, double var4, double var6, int var8, int var9, RenderBlocks var10, int var11)
    {
        ...
        int var13 = (var8 & 15) << 4;
        int var14 = var8 & 240;
        double var15 = ((double)var13 + var1.func_83009_v() * 16.0D) / 256.0D;
        double var17 = ((double)var13 + var1.func_83007_w() * 16.0D - 0.01D) / 256.0D;
        double var19 = ((double)var14 + var1.func_83005_z() * 16.0D) / 256.0D;
        double var21 = ((double)var14 + var1.func_83006_A() * 16.0D - 0.01D) / 256.0D;

        if (var1.func_83009_v() < 0.0D || var1.func_83007_w() > 1.0D)
        {
            var15 = (double)(((float)var13 + 0.0F) / 256.0F);
            var17 = (double)(((float)var13 + 15.99F) / 256.0F);
        }

        if (var1.func_83005_z() < 0.0D || var1.func_83006_A() > 1.0D)
        {
            var19 = (double)(((float)var14 + 0.0F) / 256.0F);
            var21 = (double)(((float)var14 + 15.99F) / 256.0F);
        }

        double var23 = var2 + var1.func_83009_v();
        double var25 = var2 + var1.func_83007_w();
        double var27 = var4 + var1.func_83008_x();
        double var29 = var6 + var1.func_83005_z();
        double var31 = var6 + var1.func_83006_A();
    ...
    public void renderIntCornersTopFace(Block var1, double var2, double var4, double var6, int var8, int var9, RenderBlocks var10, int var11)
    {
        ...
        double var23 = var2 + var1.func_83009_v();
        double var25 = var2 + var1.func_83007_w();
        double var27 = var4 + var1.func_83010_y();
        double var29 = var6 + var1.func_83005_z();
        double var31 = var6 + var1.func_83006_A();
    ...
    public void renderIntCornersEastFace(Block var1, double var2, double var4, double var6, int var8, int var9, RenderBlocks var10, int var11)
    {
        ...
        double var15 = ((double)var13 + var1.func_83009_v() * 16.0D) / 256.0D;
        double var17 = ((double)var13 + var1.func_83007_w() * 16.0D - 0.01D) / 256.0D;
        double var19 = ((double)var14 + var1.func_83008_x() * 16.0D) / 256.0D;
        double var21 = ((double)var14 + var1.func_83010_y() * 16.0D - 0.01D) / 256.0D;
        double var23;
        ...
        if (var1.func_83008_x() < 0.0D || var1.func_83010_y() > 1.0D)
        {
            var19 = (double)(((float)var14 + 0.0F) / 256.0F);
            var21 = (double)(((float)var14 + 15.99F) / 256.0F);
        }

        var23 = var2 + var1.func_83009_v();
        double var25 = var2 + var1.func_83007_w();
        double var27 = var4 + var1.func_83008_x();
        double var29 = var4 + var1.func_83010_y();
        double var31 = var6 + var1.func_83005_z();
        double var33 = var6 + var1.func_83006_A();
    ...
    public void renderIntCornersWestFace(Block var1, double var2, double var4, double var6, int var8, int var9, RenderBlocks var10, int var11)
    {
        ...
        double var29 = var4 + var1.func_83010_y();
        double var31 = var6 + var1.func_83006_A();
        double var33 = var6 + var1.func_83005_z();
    ...
    public void renderIntCornersNorthFace(Block var1, double var2, double var4, double var6, int var8, int var9, RenderBlocks var10, int var11)
    {
        ...
        int var13 = (var8 & 15) << 4;
        int var14 = var8 & 240;
        double var15 = ((double)var13 + var1.func_83005_z() * 16.0D) / 256.0D;
        double var17 = ((double)var13 + var1.func_83006_A() * 16.0D - 0.01D) / 256.0D;
        double var19 = ((double)var14 + var1.func_83008_x() * 16.0D) / 256.0D;
        double var21 = ((double)var14 + var1.func_83010_y() * 16.0D - 0.01D) / 256.0D;
        double var23;
        ...
        var23 = var2 + var1.func_83009_v();
        double var25 = var4 + var1.func_83008_x();
        double var27 = var4 + var1.func_83010_y();
        double var29 = var6 + var1.func_83005_z();
        double var31 = var6 + var1.func_83006_A();
        double var33 = var2 + var1.func_83007_w();
    ...
    public void renderIntCornersSouthFace(Block var1, double var2, double var4, double var6, int var8, int var9, RenderBlocks var10, int var11)
    {
        ...
        var23 = var2 + var1.func_83007_w();
        double var25 = var4 + var1.func_83008_x();
        double var27 = var4 + var1.func_83010_y();
        double var29 = var6 + var1.func_83005_z();
        double var31 = var6 + var1.func_83006_A();
        double var33 = var2 + var1.func_83009_v();
